...
| `meta-docs import-cli --source-workspace <path> (--workspace <path> \| --new-workspace <path>) [--application <id>] [--group <name>] [--ordinal <n>] [--source-id <id>]` | Import or refresh one authored MetaCli workspace into a MetaDocs workspace while preserving authored commentary. | `meta-docs import-cli --source-workspace .\MetaTransformBinding.Cli\meta-transform-binding.MetaCli --new-workspace .\MetaDocsWS --group meta-bi --ordinal 80` |
