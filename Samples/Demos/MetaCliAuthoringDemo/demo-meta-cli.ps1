...
Invoke-MetaCli @("add-application-option", "--workspace", $workspaceRelativePath, "--parameter-id", "param-workspace", "--option-id", "option-workspace", "--application", "app-demo", "--name", "workspace", "--value-shape", "shape-path", "--token-id", "token-workspace", "--token", "--workspace") @(0)
...
Invoke-MetaCli @("add-option", "--workspace", $workspaceRelativePath, "--parameter-id", "param-visibility", "--option-id", "option-visibility", "--executable-command", "exec-add-property", "--name", "visibility", "--value-shape", "shape-visibility", "--token-id", "token-visibility", "--token", "--visibility") @(0)
