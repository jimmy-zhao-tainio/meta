...
internal static class Program
{
    ...
    private static void PrintHelp()
    {
        ...
        {
            @"meta-fabric add-weave --workspace MetaFabric\Workspaces\MetaFabric --alias Parent --workspace-path MetaWeave\Workspaces\Weave-Scoped-Group-Category",
            @"meta-fabric add-binding --workspace MetaFabric\Workspaces\MetaFabric --name ParentGroup --weave Parent --source-entity Group --source-property Name --target-entity Category --target-property Name",
